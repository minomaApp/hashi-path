...
namespace Voodoo.Tiny.Sauce.Internal
{
    ...
    public class TinySauceSettings : ScriptableObject
    {
        ...
        [Tooltip("Enable this option if your game shows any type of advertising, including banners, interstitial ads, or rewarded videos.")]
        public bool doesYourGameDisplayAds;
