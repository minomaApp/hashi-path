...
namespace AlmostEngine.SimpleLocalization
{
    ...
    [CreateAssetMenu(fileName = "LocalizationLanguages",
        menuName = "AlmostEngine/Simple Localization/LocalizationLanguages")]
#endif
    public class SimpleLocalizationLanguagesAsset : ScriptableObject
    {
        ...
        public static void SetLanguage(string id)
        {
            ...
            ISimpleLocalizer[] localizers = GameObject.FindObjectsByType<ISimpleLocalizer>(FindObjectsSortMode.None);
